  ...
  module Patches
    module MailerPatch
      ...
      module InstanceMethods
        ...
        def timesheet_submitted(manager, user, start_date, end_date, url)
          recipients [manager.mail, user.mail]
        ...
        #
        def timesheet_approved(manager, user, start_date, end_date, url)
